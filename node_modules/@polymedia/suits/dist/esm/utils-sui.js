 ...
 */
export async function devInspectAndGetResults(suiClient, txb, sender = "0x7777777777777777777777777777777777777777777777777777777777777777") {
 ...
 */
export async function devInspectAndGetReturnValues(suiClient, txb, sender = "0x7777777777777777777777777777777777777777777777777777777777777777") {
 ...
 */
export async function fetchAllDynamicFields(suiClient, parentId, sleepBetweenRequests = 333, // milliseconds
verbose = false) {
    const allFieldsInfo = [];
 ...
 */
export async function getCoinOfValue(suiClient, txb, ownerAddress, coinType, coinValue) {
    let coinOfValue;
 ...
 */
export function getSuiObjectResponseFields(resp, typeRegex) {
    if (resp.error) {
        throw Error(`response error: ${JSON.stringify(resp, null, 2)}`);
    }
 ...
 */
export function makeExplorerUrl(network, kind, address) {
 ...
 */
export async function requestSuiFromFaucet(network, address) {
    let faucetUrl;
    if (network == "localnet") {
 ...
 */
export function shortenSuiAddress(text, start = 4, end = 4, separator = "…", prefix = "0x") {
    if (!text)
        return "";
 ...
 */
export function validateAndNormalizeSuiAddress(address) {
    if (address.length === 0) {
        return null;
    }
