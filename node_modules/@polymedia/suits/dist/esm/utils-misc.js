 ...
 */
export function convertNumberToBigInt(num, decimals) {
 ...
 */
export function convertBigIntToNumber(big, decimals) {
 ...
 * @see formatNumber
 */
export function formatBigInt(big, decimals, format = "standard") {
